		                        ...
		                        <div id="" class="block">
									...
									?>
										...
										<div class="control-group">
											...
											<div class="controls">
											<input type="text" value="<?php echo $row['subject_code']; ?>" name="subject_code" id="inputEmail" placeholder="Codigo Asignatura">
											</div>
										</div>
										<div class="control-group">
											<label class="control-label" for="inputPassword">Titulo de Asignatura</label>
											<div class="controls">
											<input type="text" value="<?php echo $row['subject_title']; ?>" class="span8" name="title" id="inputPassword" placeholder="Titulo de Asignatura" required>
											</div>
										</div>
										<div class="control-group">
