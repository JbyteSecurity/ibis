		                    ...
		                    <div class="row-fluid">
		                        ...
		                        <div class="block">
		                            <div class="navbar navbar-inner block-header">
		                                <div class="muted pull-left">Agregar Asignatura</div>
		                            </div>
									...
									<a href="subjects.php"><i class="icon-arrow-left"></i> Back</a>
										...
										<div class="control-group">
											...
											<div class="controls">
											<input type="text" name="subject_code" id="inputEmail" placeholder="Codigo Asignatura">
											</div>
										</div>
										<div class="control-group">
											<label class="control-label" for="inputPassword">Titulo Asignatura</label>
											<div class="controls">
											<input type="text" class="span8" name="title" id="inputPassword" placeholder="Titulo Asignatura" required>
											</div>
										</div>
										<div class="control-group">
										...
										<div class="control-group">
											...
											<div class="controls">
													<textarea name="Descripcion" id="ckeditor_full"></textarea>
											</div>
										</div>
										...
										mysql_query("insert into activity_log (date,username,action) values(NOW(),'$user_username','Agregar Asignatura $subject_code')")or die(mysql_error());
